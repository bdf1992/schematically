...
DOCUMENTED = [
    ...
    'view.appearance', 'view.setAppearance', 'view.legend', 'view.setLegend', 'view.narration', 'view.narrate', 'view.colour', 'view.setColour', 'view.paletteAudit', 'layout.contrast', 'view.globalRate', 'view.setGlobalRate',
