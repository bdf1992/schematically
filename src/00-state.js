...
const GROUPS = {"Primitives": ["point","path","plane","pod"], "Components": ["blank","act","hold","buffer","gate","switch","limit","receipt","observe"]};
...
const DIMENSIONAL_LADDER=[
  ...
  {symbolId:'pod',dimension:3,sense:'within',boundedBy:'Planes',available:true}
];
const SURFACE_DIMENSION=2;   // the dimension at which a form bounds a region; 3D borrows it
const DIMENSION_NAMES=['Point','Path','Plane','Pod'];
const nextDimension=d=>(Number(d)+1)%DIMENSION_NAMES.length;
const previousDimension=d=>(Number(d)+DIMENSION_NAMES.length-1)%DIMENSION_NAMES.length;
...
const patternHullsG=document.getElementById('patternHulls');
const patternDetail=document.getElementById('patternDetail');
const qName=document.getElementById('qName'),qSense=document.getElementById('qSense'),qLabel=document.getElementById('qLabel');
const qParts=document.getElementById('qParts'),qParent=document.getElementById('qParent'),qScope=document.getElementById('qScope');
const qState=document.getElementById('qState'),qMeaning=document.getElementById('qMeaning');
...
const patternBarFields=document.getElementById('patternBarFields');
const barPatternKind=document.getElementById('barPatternKind');
const barPatternLabel=document.getElementById('barPatternLabel');
const barPatternColorSlot=document.getElementById('barPatternColorSlot');
const barPatternOpen=document.getElementById('barPatternOpen');
const barPatternRelease=document.getElementById('barPatternRelease');
...
const pointsSurface=document.getElementById('pointsSurface');
const pointsSummary=document.getElementById('pointsSummary');
const pointsList=document.getElementById('pointsList');
const pointsBuiltinToggle=document.getElementById('pointsBuiltinToggle');
...
const nodes=diagram.components,wires=diagram.wires,patternRecords=diagram.patterns;
