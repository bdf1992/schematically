...
`ATTACHMENT-POINT-MODEL.md`, `FORM-MODEL.md` (and the proposed `SECTION-MODEL.md`), `HOST-SURFACE-MODEL.md`, `CANVAS-MODEL.md`, and `reference/REFERENCE.md` specify these in detail.
